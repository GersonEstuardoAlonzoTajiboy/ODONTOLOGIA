...
export const PDFGenerator = ({
  ...
  doc.setFontSize(18);
  doc.text('CLINICA DENTAL RC', 14, 20, { align: 'center' });
  doc.setFontSize(14);
  doc.text('DATOS DEL PACIENTE', 14, 30);
  doc.setFontSize(12);
  doc.text(`Nombre paciente: ${fullNamePatient}`, 14, 40);
  doc.setFontSize(14);
  doc.text('CUESTIONARIO DE SALUD', 14, 50, { align: 'center' });
  doc.setFontSize(12);
  ...
  doc.setFontSize(14);
  doc.text('EVALUACION FISICA', 14, 180, { align: 'center' });
  doc.setFontSize(12);
  ...
  doc.setFontSize(14);
  doc.text('TRATAMIENTOS', 14, 230, { align: 'center' });
  doc.autoTable({
    startY: 240,
  ...
  doc.setFontSize(14);
  doc.text('PRESUPUESTO', 14, doc.lastAutoTable.finalY + 10, { align: 'center' });
  doc.autoTable({
