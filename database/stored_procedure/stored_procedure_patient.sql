...
BEGIN 
    ...
    END;
    START TRANSACTION; 
        INSERT INTO patient (full_name, address, email, phone, sex, birth_date, name_contact, relationship, emergency_phone, createdAt, updatedAt)
        VALUES (p_full_name, p_address, p_email, p_phone, p_sex, p_birth_date, p_name_contact, p_relationship, p_emergency_phone, NOW(), NOW());
    COMMIT;
END //
DELIMITER ;
